...
public class UpdateIncidentDataProvider extends BaseClass
{
	@BeforeTest
	public void SetData()
	{
		excelFilePath = "./TestData/ServiceNow/tc002.xlsx";
	}
	
	@Test(dataProvider = "Dynamic_Data")
	public void updateIncident(String userName, String password, String filterIncident, String workNote) throws InterruptedException
	{
		...
		//5. Update the incidents with Urgency as High and State as In Progress
		 ...
		 //5.3. Work notes
		 driver.findElement(By.xpath("(//textarea[@placeholder='Work notes'])[1]")).sendKeys(workNote);
